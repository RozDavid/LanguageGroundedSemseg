...
class cfl_collate_fn_factory:
  ...
  def __call__(self, list_data):
    coords, feats, labels, instances, scene_names = list(zip(*list_data))
    ...
    return coords_batch, feats_batch, labels_batch, instances_batch, scene_names
...
class cflt_collate_fn_factory:
  ...
  def __call__(self, list_data):
    coords, feats, labels, instances, scene_names, transformations = list(zip(*list_data))
    cfl_collate_fn = cfl_collate_fn_factory(limit_numpoints=self.limit_numpoints)
    coords_batch, feats_batch, labels_batch, instances_batch, scene_names = cfl_collate_fn(list(zip(coords, feats, labels, instances, scene_names)))
    ...
    return coords_batch, feats_batch, labels_batch, instances_batch, scene_names, transformations_batch
