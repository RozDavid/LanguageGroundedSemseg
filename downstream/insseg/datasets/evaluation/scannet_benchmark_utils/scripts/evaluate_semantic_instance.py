...
import util_3d
from lib.constants.scannet_constants import VALID_CLASS_IDS_200, CLASS_LABELS_200, PARENT_CLASS_SUPERCAT, VALID_PARENT_IDS_SUPERCAT
...
if __name__ == '__main__':
    ...
    VALID_LABELS_INSTANCE = np.array([l for l in CLASS_LABELS if l not in PARENT_CLASS_SUPERCAT])
    VALID_CLASS_IDS_INSTANCE = np.array([i for i in CLASS_IDS if i not in VALID_PARENT_IDS_SUPERCAT])

    evaluator = Evaluator(CLASS_LABELS=VALID_LABELS_INSTANCE, VALID_CLASS_IDS=VALID_CLASS_IDS_INSTANCE)
